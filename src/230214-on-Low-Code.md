> I'm not very good at narrowing down the focus on learning things. Here I listed a **limited** set of the *best* resources I could find, so I could try to make the best of use of the limited time I have.
<!-- toc -->
...
- [antdimot/awesome-lowcode: Collection of Low-code Development Platform](https://github.com/antdimot/awesome-lowcode)

## Tooling

- [Documentation for *Actionsflow*](https://actionsflow.github.io/docs/)
- [Documentation for *IFTTT*](https://ifttt.com/docs)
