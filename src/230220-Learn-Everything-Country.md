> Learn more than just the names on every countries on Earth
<!-- toc -->
...
- I am definitely starting with *some* goals in mind
- This post might eventually merged into other Topic-like *On X* posts

### Starting Point

- [List of Countries and Dependencies by Area](https://en.wikipedia.org/wiki/List_of_countries_and_dependencies_by_area)
- [Countries in the World | Worldometer](https://www.worldometers.info/geography/how-many-countries-are-there-in-the-world/)
